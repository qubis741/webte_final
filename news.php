...
<?php
	...
	if (isset($_POST['odoberanie'])) {		
		...
		if(!$m){
		    ...
		    $msg = "<html><head><meta charset=" . "UTF-8" ."></head><body><p>Prosim potrvrdte odoberanie cez mail:</p> " . "<a href='http://147.175.98.168/?page=aktuality&pmail=" . $_POST['mail'] . "'> Potvrdenie</a>";
		    $msg = $msg . "<br><br><p>Odoberanie mozete zrusit kliknutim na tento link:</p> ";
		    $msg = $msg . "<a href='http://147.175.98.168/?page=aktuality&zmail=" . $_POST['mail'] . "'> Zrusenie</a></body></html>";
